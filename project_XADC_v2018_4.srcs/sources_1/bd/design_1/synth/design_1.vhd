...
architecture STRUCTURE of design_1 is
  ...
  component design_1_Contador_26_0_0 is
  port (
    CLK : in STD_LOGIC;
    RST : in STD_LOGIC;
    rd_clk : out STD_LOGIC
  );
  end component design_1_Contador_26_0_0;
  component design_1_Contador_52_0_0 is
  port (
    CLK : in STD_LOGIC;
    RST : in STD_LOGIC;
    wr_clk : out STD_LOGIC
  ...
  end component design_1_FSM_FIFO_Entregable_0_2;
...
Contador_26_0: component design_1_Contador_26_0_0
     port map (
      CLK => clk_wiz_0_clk_out1,
      RST => reset_in_0_1,
      rd_clk => Contador_26_0_rd_clk
    );
Contador_52_0: component design_1_Contador_52_0_0
     port map (
      CLK => clk_wiz_0_clk_out1,
      RST => reset_in_0_1,
      wr_clk => Contador_52_0_wr_clk
    );
FSM_FIFO_Entregable_0: component design_1_FSM_FIFO_Entregable_0_2
     port map (
      clk => clk_wiz_0_clk_out1,
      locked => clk_wiz_0_locked,
