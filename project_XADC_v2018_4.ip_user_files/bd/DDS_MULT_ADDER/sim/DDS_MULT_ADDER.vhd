...
entity DDS_MULT_ADDER is
  ...
  attribute CORE_GENERATION_INFO of DDS_MULT_ADDER : entity is "DDS_MULT_ADDER,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=DDS_MULT_ADDER,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of DDS_MULT_ADDER is
  ...
  component DDS_MULT_ADDER_arst_sinc_0_0 is
  port (
    input_signal : in STD_LOGIC;
    output_signal : out STD_LOGIC
  );
  end component DDS_MULT_ADDER_arst_sinc_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk_576MHz : signal is "XIL_INTERFACENAME CLK.CLK_576MHZ, CLK_DOMAIN DDS_MULT_ADDER_clk_576MHz, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
arst_sinc_0: component DDS_MULT_ADDER_arst_sinc_0_0
     port map (
