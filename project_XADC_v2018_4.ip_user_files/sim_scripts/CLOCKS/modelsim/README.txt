...
#
# Generated by export_simulation on Fri Nov 01 19:51:39 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './CLOCKS.sh' script.
...
./CLOCKS.sh -noclean_files

For more information on the script, please type './CLOCKS.sh -help'.
