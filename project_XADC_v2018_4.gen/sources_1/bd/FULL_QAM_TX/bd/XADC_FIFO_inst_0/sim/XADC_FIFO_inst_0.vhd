...
--Date        : Sun Nov 17 17:17:33 2024
--Host        : workstation running 64-bit major release  (build 9200)
--Command     : generate_target XADC_FIFO_inst_0.bd
--Design      : XADC_FIFO_inst_0
...
entity XADC_FIFO_inst_0 is
  ...
  attribute CORE_GENERATION_INFO of XADC_FIFO_inst_0 : entity is "XADC_FIFO_inst_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=XADC_FIFO_inst_0,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=C_/Users/nicol/Documents/GitHub/tx-16-QAM/project_XADC_v2018_4.srcs/sources_1/bd/XADC_FIFO/XADC_FIFO.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of XADC_FIFO_inst_0 : entity is "XADC_FIFO_inst_0.hwdef";
end XADC_FIFO_inst_0;

architecture STRUCTURE of XADC_FIFO_inst_0 is
  component XADC_FIFO_inst_0_Contador_26_0_0 is
  port (
    CLK : in STD_LOGIC;
    RST : in STD_LOGIC;
    rd_clk : out STD_LOGIC
  );
  end component XADC_FIFO_inst_0_Contador_26_0_0;
  component XADC_FIFO_inst_0_Contador_52_0_0 is
  port (
    CLK : in STD_LOGIC;
    RST : in STD_LOGIC;
    wr_clk : out STD_LOGIC
  );
  end component XADC_FIFO_inst_0_Contador_52_0_0;
  component XADC_FIFO_inst_0_FSM_FIFO_Entregable_0_0 is
  port (
  ...
  end component XADC_FIFO_inst_0_FSM_FIFO_Entregable_0_0;
  component XADC_FIFO_inst_0_fifo_generator_0_0 is
  port (
    rst : in STD_LOGIC;
    wr_clk : in STD_LOGIC;
    rd_clk : in STD_LOGIC;
  ...
  end component XADC_FIFO_inst_0_fifo_generator_0_0;
  component XADC_FIFO_inst_0_xadc_wiz_0_0 is
  port (
  ...
  end component XADC_FIFO_inst_0_xadc_wiz_0_0;
...
Contador_26_0: component XADC_FIFO_inst_0_Contador_26_0_0
     port map (
      CLK => clk_wiz_0_clk_out1,
      RST => reset_in_0_1,
      rd_clk => Contador_26_0_rd_clk
    );
Contador_52_0: component XADC_FIFO_inst_0_Contador_52_0_0
     port map (
      CLK => clk_wiz_0_clk_out1,
      RST => reset_in_0_1,
      wr_clk => Contador_52_0_wr_clk
    );
FSM_FIFO_Entregable_0: component XADC_FIFO_inst_0_FSM_FIFO_Entregable_0_0
     port map (
      clk => clk_wiz_0_clk_out1,
      locked => clk_wiz_0_locked,
...
fifo_generator_0: component XADC_FIFO_inst_0_fifo_generator_0_0
     port map (
...
xadc_wiz_0: component XADC_FIFO_inst_0_xadc_wiz_0_0
     port map (
